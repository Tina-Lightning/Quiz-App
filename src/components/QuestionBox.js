        ...
        <div className="flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-6 mt-6">
                {answers.map((answer, index) => {
                    ...
                    return (
                        <button key={index} className={`${textColor} bg-white p-4 font-semibold rounded shadow`}
            ...
            {showAnswers && (
                ...
                className="bg-purple-700 text-white p-4 font-semibold rounded shadow mt-6">Next Question</button>
            )}
